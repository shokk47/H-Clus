 ...
 *
 * Questa classe fornisce metodi per inizializzare, ottenere e chiudere la connessione al database.
 * Utilizza il driver JDBC per connettersi a un database MySQL.
 *
 * @author Map Tutor
 */
